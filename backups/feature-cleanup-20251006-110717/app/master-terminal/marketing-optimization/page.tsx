      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="text-2xl">{platformIcons[campaign.platform as keyof typeof platformIcons] || '📊'}</div>
            <div>
...
// Removed duplicate CampaignCard definition - using enhanced version above (lines 195-331)
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="text-2xl">
                    ...
                    {!['google_ads', 'meta', 'linkedin'].includes(platform.platform) && '📊'}
                  </div>
                  <div>
                    <h4 className="font-medium capitalize">{platform.platform.replace('_', ' ')}</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {platform.campaigns} campaigns • {platform.leads} leads
                    </p>
                  </div>
                </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select 
              ...
              onValueChange={(value) => 
                updateAISettings({ mode: value as 'conservative' | 'balanced' | 'aggressive' })
              }
            >
              <SelectTrigger>
                <SelectValue />
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {decision.ai_system} • {Math.round(decision.decision.confidence * 100)}% confidence
                        </p>
                      </div>
                      <Badge 
                        variant={
