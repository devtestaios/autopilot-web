...
-- 1.1 Companies/Organizations Table (created first due to FK dependencies)
CREATE TABLE IF NOT EXISTS public.companies (
  ...
  created_by UUID
  -- Note: created_by FK constraint added after profiles table is created
);

-- 1.2 Enhanced Profiles Table (extends Supabase auth.users)
...
-- Add foreign key constraint for companies.created_by after profiles table exists
