...
function AIOverview({ stats }: { stats: any[] }) {
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6">
        ...
        <div className="space-y-4">
          {(capabilities || []).map((capability) => (
            <div key={capability.id} className="flex items-center justify-between p-4 bg-white dark:bg-gray-600 rounded-lg">
