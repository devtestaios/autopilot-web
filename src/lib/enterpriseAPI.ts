...
export class EnterpriseCompanyAPI {
  ...
  private static getSubscriptionLimits(tier: string) {
    const limits = {
      trial: { users: 10, storage_gb: 5, api_calls_month: 5000 },
      solo_professional: { users: 1, storage_gb: 10, api_calls_month: 15000 },
      growth_team: { users: 3, storage_gb: 50, api_calls_month: 50000 },
      professional_agency: { users: 10, storage_gb: 200, api_calls_month: 200000 },
      enterprise: { users: 30, storage_gb: 1000, api_calls_month: 1000000 },
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    description: 'Full platform access for solo entrepreneurs and teams up to 10 users',
    price_monthly: 0,
    price_yearly: 0,
    features: [
      'Full platform access',
      'All social media suites',
