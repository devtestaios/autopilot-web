...
export default function Navbar({ onMenuToggle }: NavbarProps) {
  ...
  return (
    <nav className="bg-white dark:bg-black backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 px-4 py-3 transition-all duration-300 sticky top-0 z-40 text-gray-900 dark:text-gray-300">
